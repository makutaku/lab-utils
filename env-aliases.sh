...
alias ak-harvester-up='sudo ./deploy-stacks.sh up harvester.manifest'
alias ak-harvester-down='sudo ./deploy-stacks.sh down harvester.manifest'
alias ak-gateway-up='sudo ./deploy-stacks.sh up gateway.manifest'
alias ak-gateway-down='sudo ./deploy-stacks.sh down gateway.manifest'
alias ak-home-gateway-up='sudo ./deploy-stacks.sh up home-gateway.manifest'
alias ak-home-gateway-down='sudo ./deploy-stacks.sh down home-gateway.manifest'
alias ak-nextcloud-up='sudo ./deploy-stacks.sh up nextcloud.manifest'
alias ak-nextcloud-down='sudo ./deploy-stacks.sh down nextcloud.manifest'
alias ak-netops-up='sudo ./deploy-stacks.sh up netops.manifest'
alias ak-netops-down='sudo ./deploy-stacks.sh down netops.manifest'
alias ak-dev-up='sudo ./deploy-stacks.sh up dev.manifest'
alias ak-dev-down='sudo ./deploy-stacks.sh down dev.manifest'
